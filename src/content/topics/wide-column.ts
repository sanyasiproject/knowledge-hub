...
improved"]`,
  ...
  resources: [
    ...
    { label: "Google Bigtable paper (2006)", url: "https://static.googleusercontent.com/media/research.google.com/en//archive/bigtable-osdi06.pdf", kind: "paper", note: "The foundational paper that inspired HBase, Cassandra, and the wide-column model." },
    ...
    { label: "Apache Cassandra documentation", url: "https://cassandra.apache.org/doc/latest/", kind: "docs", note: "Official reference for CQL, configuration, and operational procedures." },
    ...
    { label: "Designing Data-Intensive Applications — Ch. 3", url: "https://dataintensive.net/", kind: "book", note: "Martin Kleppmann's deep coverage of LSM trees, SSTables, and storage engine internals." },
  ],
  glossary: [
