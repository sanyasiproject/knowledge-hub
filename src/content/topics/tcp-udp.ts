...
with app-layer retry"]`,
  ...
  resources: [
    { label: "RFC 793 - Transmission Control Protocol", url: "https://www.rfc-editor.org/rfc/rfc793", kind: "docs", note: "The original TCP specification defining the protocol's core mechanics, state machine, and header format." },
    { label: "RFC 768 - User Datagram Protocol", url: "https://www.rfc-editor.org/rfc/rfc768", kind: "docs", note: "The UDP specification — remarkably short at just 3 pages, reflecting the protocol's simplicity." },
    { label: "RFC 9000 - QUIC: A UDP-Based Multiplexed and Secure Transport", url: "https://www.rfc-editor.org/rfc/rfc9000", kind: "docs", note: "The QUIC transport protocol specification, the foundation for HTTP/3." },
    ...
    { label: "RFC 5681 - TCP Congestion Control", url: "https://www.rfc-editor.org/rfc/rfc5681", kind: "docs", note: "Defines slow start, congestion avoidance, fast retransmit, and fast recovery algorithms." },
    ...
    { label: "RFC 7323 - TCP Extensions for High Performance", url: "https://www.rfc-editor.org/rfc/rfc7323", kind: "docs", note: "Defines window scaling, timestamps, and PAWS (Protection Against Wrapped Sequence numbers) for high-bandwidth links." },
    { label: "Beej's Guide to Network Programming", url: "https://beej.us/guide/bgnet/", kind: "article", note: "Practical, hands-on guide to socket programming in C covering both TCP and UDP with clear examples." },
