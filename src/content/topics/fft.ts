 ...
 */
export const fft: TopicContent = {
  quickSummary: [
    "FFT evaluates polynomials at roots of unity so multiplication becomes pointwise; inverse FFT recovers coefficients.",
    "Multiplies million-term polynomials (or big numbers) in O(n log n) over doubles.",
  ],
  code: [
    {
      language: "cpp",
      caption: "Template \u2014 Fast Fourier Transform",
...
vector<ll> mult(vector<ll> a, vector<ll> b)
{
  ...
  cheatSheet: [
    "Pad to a power of two \u2265 result size.",
    "Watch precision \u2014 round carefully; use NTT for exact modular results.",
  ],
};
