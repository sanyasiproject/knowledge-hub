 ...
 */
export const matrixOperations: TopicContent = {
  quickSummary: [
    "Encode a linear recurrence as a matrix; the n-th term is a matrix power away \u2014 O(k\u00b3 log n).",
    "Includes the standard multiply/identity/power toolkit used for Fibonacci-style and graph path counting.",
  ],
  code: [
    {
      language: "cpp",
      caption: "Template \u2014 Matrix Operations & Fast Power",
      source: `#include<bits/stdc++.h>
using namespace std;

//set this macro need to use modulo in matrix operations
...
int main()
{
  ...
  cheatSheet: [
    "Any fixed linear recurrence \u2192 matrix power.",
    "Path counts of length L = adjacency matrix to the L-th power.",
  ],
};
