...
public:
  ...
  diagrams: [
    {
      ...
      kind: "architecture",
      caption:
        "Two-plane architecture: AWS control plane for business logic, Open Connect data plane for video delivery",
      mermaid: `graph LR
  ...
  resources: [
    ...
    {
      label: "High Performance Browser Networking by Ilya Grigorik",
      kind: "book",
