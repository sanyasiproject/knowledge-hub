...
no implicit coercion`,
  ...
  resources: [
    ...
    { label: "TypeScript Handbook", url: "https://www.typescriptlang.org/docs/handbook/intro.html", kind: "docs", note: "Official documentation covering TypeScript's structural type system, generics, conditional types, and utility types." },
    { label: "Haskell Wiki — Type System", url: "https://wiki.haskell.org/", kind: "docs", note: "Community wiki with in-depth explanations of Haskell's type classes, kinds, GADTs, and type families." },
    ...
    { label: "Rust Reference — Type System", url: "https://doc.rust-lang.org/reference/", kind: "docs", note: "Covers ownership, borrowing, lifetimes, traits, and how they interact with Rust's type system." },
  ],
  glossary: [
