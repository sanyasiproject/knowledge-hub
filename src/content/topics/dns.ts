...
// int main() { resolve("example.com"); }  // uncomment to run`,
  ...
  resources: [
    { label: "RFC 1034 — Domain Names: Concepts and Facilities", url: "https://www.rfc-editor.org/rfc/rfc1034", kind: "docs", note: "The foundational RFC defining the DNS architecture, namespace, and resolution model." },
    { label: "RFC 1035 — Domain Names: Implementation and Specification", url: "https://www.rfc-editor.org/rfc/rfc1035", kind: "docs", note: "Companion to RFC 1034 covering the wire protocol, message format, and master file format." },
    ...
    { label: "RFC 4033-4035 — DNSSEC Introduction and Protocol", url: "https://www.rfc-editor.org/rfc/rfc4033", kind: "docs", note: "The trio of RFCs defining DNSSEC: introduction, records/protocol, and validation." },
    { label: "RFC 8484 — DNS Queries over HTTPS (DoH)", url: "https://www.rfc-editor.org/rfc/rfc8484", kind: "docs", note: "Specifies how DNS queries are encoded in HTTPS requests for encrypted resolution." },
    { label: "Cloudflare Learning Center — DNS", url: "https://www.cloudflare.com/learning/", kind: "article", note: "Accessible, well-illustrated explanations of DNS concepts from basics through advanced topics." },
