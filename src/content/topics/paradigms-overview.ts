...
LIMIT 5;`,
  ...
  resources: [
    ...
    { label: "Learn You a Haskell for Great Good!", url: "https://learnyouahaskell.com/", kind: "book", note: "Beginner-friendly introduction to pure functional programming in Haskell. Free online." },
