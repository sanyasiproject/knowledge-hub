...
await reportQueue.removeRepeatableByKey(repeatableJobs[0].key);`,
  ...
  resources: [
    ...
    { label: "Designing Data-Intensive Applications, Ch. 11", url: "https://dataintensive.net/", kind: "book", note: "Martin Kleppmann covers message brokers, exactly-once semantics, and stream processing." },
    { label: "Enterprise Integration Patterns", url: "https://www.enterpriseintegrationpatterns.com/", kind: "book", note: "Gregor Hohpe's patterns for messaging, including dead letter channels, retry, and idempotent receivers." },
  ],
  glossary: [
