...
producer.close();`,
  ...
  resources: [
    ...
    { label: "The Log: What every software engineer should know", url: "https://engineering.linkedin.com/distributed-systems/log-what-every-software-engineer-should-know-about-real-time-datas-unifying", kind: "article", note: "Jay Kreps' foundational article on append-only logs" },
    { label: "Designing Data-Intensive Applications (Ch. 3, 11)", url: "https://dataintensive.net/", kind: "book", note: "Martin Kleppmann on storage engines and stream processing" },
