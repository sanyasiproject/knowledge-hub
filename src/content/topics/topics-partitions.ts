...
from committed offsets"]`,
  ...
  resources: [
    { label: "Kafka Documentation - Topics and Partitions", url: "https://kafka.apache.org/documentation/", kind: "docs", note: "Official Apache Kafka documentation on topic configuration" },
    { label: "Designing Data-Intensive Applications (Ch. 6)", url: "https://dataintensive.net/", kind: "book", note: "Martin Kleppmann on partitioning strategies" },
