...
export const topicsPartitions: TopicContent = {
  ...
  code: [
    ...
    {
      language: "python",
      caption: "Inspecting topic partitions and increasing partition count",
      source: [
        ...
        "topic_metadata = admin.describe_topics(['order-events'])",
        "",
        ...
        "    'order-events': NewPartitions(total_count=12)",
        "})",
        "",
        ...
        "",
        "for msg in consumer:",
        "    print(f\"Partition {msg.partition}, Offset {msg.offset}: {msg.key}\")",
        "    if msg.offset > 100:",
        "        break",
      ].join("\n"),
    },
