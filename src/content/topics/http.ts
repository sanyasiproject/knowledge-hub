...
async function deleteUser(id) {
  ...
  resources: [
    { label: "RFC 9110 — HTTP Semantics", kind: "docs", note: "The definitive specification for HTTP methods, status codes, headers, and content negotiation." },
    { label: "RFC 9113 — HTTP/2", kind: "docs", note: "HTTP/2 protocol specification including framing, multiplexing, and HPACK." },
    { label: "RFC 9114 — HTTP/3", kind: "docs", note: "HTTP/3 specification defining how HTTP maps onto QUIC." },
    { label: "RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport", kind: "docs", note: "The QUIC transport protocol that HTTP/3 runs on." },
    { label: "High Performance Browser Networking by Ilya Grigorik", kind: "book", note: "Excellent coverage of HTTP/1.1, HTTP/2, TLS, and network performance — freely available online at hpbn.co." },
    ...
    { label: "MDN Web Docs — HTTP", kind: "docs", note: "Comprehensive, accessible reference for all HTTP concepts, headers, and status codes." },
