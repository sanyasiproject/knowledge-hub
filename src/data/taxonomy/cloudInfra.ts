    ...
    categories: [
      {
        ...
        topics: [
          { slug: "service-models", title: "IaaS, PaaS & SaaS", summary: "The layers of cloud abstraction.", level: "Beginner", tags: ["cloud"], contentReady: ["quick-summary", "comparison", "diagrams", "interview-qa"], related: ["deployment-models", "shared-responsibility", "cloud-cost", "aws-compute", "container-fundamentals"] },
