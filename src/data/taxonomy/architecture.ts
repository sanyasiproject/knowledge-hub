    ...
    categories: [
      ...
      },
      {
        ...
        topics: [
          ...
          { slug: "design-typeahead", title: "Design Typeahead/Autocomplete", summary: "Trie, prefix search, ranking.", level: "Advanced", tags: ["system-design", "hld", "lld"], contentReady: ["quick-summary", "detailed-explanation", "deep-dive", "code-examples", "diagrams", "interview-qa", "mcqs", "flashcards", "exercises", "revision-notes", "cheat-sheet", "glossary", "comparison", "follow-ups", "resources"], related: ["design-search-engine", "tries", "design-distributed-cache", "building-blocks", "hld-fundamentals"] },
